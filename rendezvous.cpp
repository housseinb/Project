...
RendezVous::RendezVous(int id_rdv, int id_client, QString code_fiscal, QString nom,
...
QString RendezVous::getCodeFiscal() { return code_fiscal; }
void RendezVous::setCodeFiscal(QString code_fiscal) { this->code_fiscal = code_fiscal; }
